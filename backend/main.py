...
# this for making live on Render
# backend/main.py
# ---------------------------------------------------------------
# 🌿 Riverwood Voice Agent Backend (FastAPI)
# Description: AI Site Supervisor that chats + speaks responses
...
# Enable CORS so frontend (Vercel + local) can call backend (Render)
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
        "http://localhost:5173",
...
# ===============================================================
# 🧠 4. Riverwood Knowledge Base (System Prompt)
# ===============================================================
RIVERWOOD_KNOWLEDGE = """
You are Riverwood - the official AI Site Supervisor of Riverwood Projects LLP.
Company: Riverwood Projects LLP - Haryana's most trusted DDJAY plotted developer.
...
# ===============================================================
# ❤️ 10. Health Check Endpoint
# ===============================================================
@app.get("/")
async def home():
    """Simple root endpoint"""
    return {"message": "Riverwood AI Backend is live on Render 🚀"}
